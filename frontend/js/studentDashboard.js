  ...
  materialGrid.innerHTML = materials.length > 0
    ? materials.map(material => `
        <div class="material-card">
          ...
          <a href="https://www.inf.unibz.it/~calvanese/teaching/04-05-ip/lecture-notes/uni01.pdf" target="_blank" class="download-btn">Download</a>
        </div>
      `).join('')
    ...
    upcomingContainer.innerHTML = assignments.map(assignment => `
      <li class="assignment-item">
        ...
        <div class="assignment-actions">
          ...
          ${assignment.file_path ? `<a href="https://www.inf.unibz.it/~calvanese/teaching/04-05-ip/lecture-notes/uni01.pdf" target="_blank" class="download-btn">
    ...
    gridContainer.innerHTML = assignments.map(assignment => `
      <div class="assignment-card not-submitted">
        ...
        <div class="assignment-actions">
          ...
          ${assignment.file_path ? `<a href="https://www.inf.unibz.it/~calvanese/teaching/04-05-ip/lecture-notes/uni01.pdf" target="_blank" class="btn btn-download">
            <i class="fas fa-download"></i> Download
          </a>` : ''}
        </div>
      </div>
